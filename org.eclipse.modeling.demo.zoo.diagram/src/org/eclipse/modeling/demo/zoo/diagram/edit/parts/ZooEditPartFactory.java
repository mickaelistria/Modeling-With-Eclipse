 ...
 * @generated
 */
public class ZooEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case ZooEditPart.VISUAL_ID:
				return new ZooEditPart(view);

			case SavannahEditPart.VISUAL_ID:
				return new SavannahEditPart(view);

			case WalkwayEditPart.VISUAL_ID:
				return new WalkwayEditPart(view);

			case WaterEditPart.VISUAL_ID:
				return new WaterEditPart(view);

			case TigerEditPart.VISUAL_ID:
				return new TigerEditPart(view);
